$(function () {
    ...
    $('#fileupload').fileupload();
        ...
        //Bind the form data to send project id as an extra parameter 
        $('#fileupload').bind('fileuploadsubmit', function (e, data) {
        data.formData = {};
        });
        
        //Displays error message if no document is selected before upload
        $('#start_uploads').click(function(e){
    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            // Callback for successful uploads:
               ...
               var res = data.result;
               //var success_input = '<input type="hidden" name="img_url" id="img_url" value="'+res['artist_update_image']+'"/>';
               window.url = res['artist_update_image']
               var success_input = window.url
               $(".mob_img_url").attr('value',window.url);
               /*$("#ImageUploadFiles").append(success_input)
               $("#prof_input").parent().hide();*/
